    ...
    $('#txtDBSearch').on('keydown', function (e) {
        ...
        switch (KeyCode) {
            ...
            case (KeyCode = 32):
                ...
                break;
            default:
                ItemSearch('Investigation:ItemSearch');
                break;
        }
    });
...
function GetCategory() {
    ...
    objBO.Logic = 'Investigation:CategoryList';
    $.ajax({
        method: "POST",
        url: url,
...
function GetSubCategory() {
    ...
    objBO.Prm2 = '';
    objBO.login_id = Active.userId;
    objBO.Logic = 'Investigation:SubCatList';
    $.ajax({
        method: "POST",
        url: url,
        data: JSON.stringify(objBO),
...
function BookingInfoByIPDNo() {
    ...
    objBO.Prm2 = '';
    objBO.login_id = Active.userId;
    objBO.Logic = "Investigation:IPDBookingInfoByIPDNo";
    $.ajax({
        method: "POST",
        url: url,
        data: JSON.stringify(objBO),
